...
Source0:	http://tarballs.openstack.org/python-ironicclient/python-ironicclient-0.3.3.tar.gz
...
%changelog
* Mon Jan 19 2014 James Slagle <jslagle@redhat.com> - 0.3.3-1
- Bump to 0.3.3
- Update patch 0002-ironicclient-Prevent-pbr-dependencies-handling.patch
